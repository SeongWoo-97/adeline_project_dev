...
class WeaponWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (profile.equipList?.weapon != null) {
      ...
      List<Color> bgColors = gradeColors(weapon!.grade);
      Color nameColor = itemNameColor(weapon.grade);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    LinearPercentIndicator(
                      ...
                      progressColor: qualityColor(weapon.itemTitle!.quality),
                    ),
                  ],
                ),
              ),
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: Text("무기 공격력 +${weapon.effect!.basicEffect!}", style: Theme.of(context).textTheme.caption),
                                  ),
                                  // 추가효과
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5),
                          ...
                          weapon.setEffect == null
                              ? Container()
                              : Container(child: Html(data: weapon.setEffect, style: {'font': Style(fontSize: FontSize(12))}))
                        ],
                      ),
                    ),
                  ),
