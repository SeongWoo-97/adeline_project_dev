...
class AvatarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Avatar?> avatars = [
      profile.avatarList?.weapon,
      profile.avatarList?.head,
      profile.avatarList?.top,
      profile.avatarList?.bottom,
      profile.avatarList?.face,
      profile.avatarList?.instrument,
    ];
    return Flexible(
      child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset('assets/emptySlot/avatar/not_over/$i.png'),
                    ),
                    decoration: BoxDecoration(
                      border: Border.all(color: Colors.transparent),
                      borderRadius: BorderRadius.circular(5),
