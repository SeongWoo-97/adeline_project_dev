...
class MobileCharacterSettingsScreen extends StatefulWidget {
  final int characterIndex;

  MobileCharacterSettingsScreen(this.characterIndex);

  @override
  State<MobileCharacterSettingsScreen> createState() => _MobileCharacterSettingsScreenState();
}

class _MobileCharacterSettingsScreenState extends State<MobileCharacterSettingsScreen> {
  int tag = 0;
