...
import 'package:adeline_app/model/add_content_provider/add_content_provider.dart';
...
import 'package:adeline_app/screen/home_work/character_setting_screen/mobile/widget/add_content_widget.dart';
import 'package:drag_and_drop_lists/drag_and_drop_lists.dart';
import 'package:flutter/material.dart';
import 'package:flutter_platform_widgets/flutter_platform_widgets.dart';
import 'package:provider/provider.dart';

class NotMobileWeeklyContentsSettingsWidget extends StatefulWidget {
  final int characterIndex;

  NotMobileWeeklyContentsSettingsWidget(this.characterIndex);

  @override
  State<NotMobileWeeklyContentsSettingsWidget> createState() => _NotMobileWeeklyContentsSettingsWidgetState();
}

class _NotMobileWeeklyContentsSettingsWidgetState extends State<NotMobileWeeklyContentsSettingsWidget> {
                                                      ...
                                                      child: InkWell(
                                                        child: Container(
                                                          decoration: BoxDecoration(
                                                            ...
                                                            border: Border.all(
                                                                color: _selected == index ? Colors.white : Colors.transparent, width: 1.5),
                                                          ),
                                                          child: Image.asset(
