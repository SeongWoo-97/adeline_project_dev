...
class NotMobileDailyContentsSettingsWidget extends StatefulWidget {
  final int characterIndex;

  NotMobileDailyContentsSettingsWidget(this.characterIndex);

  @override
  State<NotMobileDailyContentsSettingsWidget> createState() => _NotMobileDailyContentsSettingsWidgetState();
}

class _NotMobileDailyContentsSettingsWidgetState extends State<NotMobileDailyContentsSettingsWidget> {
