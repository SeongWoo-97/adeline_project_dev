...
import 'package:adeline_app/screen/home_work/character_manual_add_screen/tablet_desktop/widget/not_mobile_daily_content_list.dart';
import 'package:adeline_app/screen/home_work/character_manual_add_screen/tablet_desktop/widget/not_mobile_raid_content_list.dart';
import 'package:adeline_app/screen/home_work/character_manual_add_screen/tablet_desktop/widget/not_mobile_weekly_content_list.dart';
...
class NotMobileCharacterManualAddScreen extends StatefulWidget {
  const NotMobileCharacterManualAddScreen({Key? key}) : super(key: key);

  @override
  State<NotMobileCharacterManualAddScreen> createState() => _NotMobileCharacterManualAddScreenState();
}

class _NotMobileCharacterManualAddScreenState extends State<NotMobileCharacterManualAddScreen> {
    ...
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            TextButton(
                onPressed: () => addCharacterProvider.addCharacter(context),
                child: Text(
                  '추가',
  ...
  Widget widgetPerContents(String tag) {
    switch (tag) {
      case "일일 콘텐츠":
        return NotMobileDailyContentListWidget();
      case "주간 콘텐츠":
        return NotMobileWeeklyContentListWidget();
      case "레이드 콘텐츠":
        return NotMobileRaidContentListWidget();
    }
    return Container();
  }
}
