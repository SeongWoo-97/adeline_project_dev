...
import 'package:adeline_app/screen/responsive/character_profile/rwd_character_profile_screen.dart';
      ...
      child: TextFormField(
        ...
        onFieldSubmitted: (value) {
          if (value.characters.length <= 12 && value.characters.length >= 2) {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => RwdCharacterProfileScreen(nickName: value)));
